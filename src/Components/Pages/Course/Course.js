...
const Course = ({course}) => {
    return (
        ...
        <div className="h-full relative border-2 bg-white font-custom border-gray-200 border-opacity-60  rounded-xl overflow-hidden">
          ...
          <Link to={`/details/${course.id}`} className="flex justify-center w-full bg-slate-700 mt-2 items-center hover:bg-slate-900  absolute bottom-0">
